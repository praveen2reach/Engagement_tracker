...
const ADMIN_FIELDS = ['name', 'sequence', 'predecessor_id', 'dependency_type', 'duration_days', 'is_milestone', 'functional_owner', 'technical_owner', 'integration_owner', 'client_poc'];
